#!/usr/bin/env python3
"""Evaluate a G-v3 best checkpoint with the standard six JSA maps."""
...
os.environ.setdefault("MPLCONFIGDIR", "/tmp/jsa_g_v3_mpl")
...
def main() -> None:
    ...
    if checkpoint.get("architecture") != "semantic_priority_gradient_refine_g_v3":
    ...
    print(f"Experiment G-v3 checkpoint: {checkpoint_path}", flush=True)
