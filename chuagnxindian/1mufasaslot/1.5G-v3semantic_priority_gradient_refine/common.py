"""Experiment registry and frozen L3+L4 construction for G-v3."""
...
from model import SemanticPreservingMultiGeometryRefinement  # noqa: E402
...
EXPERIMENTS = {
    "vggss_10k": {
        ...
        "default_experiment": "1.5G-v3semantic_priority_gradient_refine_vggss_10k",
        "eval_batch_size": 256,
        "workers": 16,
    ...
    "flickr_10k": {
        ...
        "default_experiment": "1.5G-v3semantic_priority_gradient_refine_flickr_10k_frame8_center5",
        "eval_batch_size": 32,
        "workers": 12,
...
def build_model(
...
) -> tuple[SemanticPreservingMultiGeometryRefinement, Path]:
    ...
    model = SemanticPreservingMultiGeometryRefinement(
...
def parameter_counts(model: SemanticPreservingMultiGeometryRefinement) -> dict[str, int]:
