...
vgg_exp=${VGG_EXPERIMENT:-1.4G-v2-semantic_preserving_multigeom_vggss_10k}
flickr_exp=${FLICKR_EXPERIMENT:-1.4G-v2-semantic_preserving_multigeom_flickr_10k_frame8_center5}
