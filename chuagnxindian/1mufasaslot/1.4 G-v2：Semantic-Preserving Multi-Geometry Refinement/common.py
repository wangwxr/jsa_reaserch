"""Experiment registry and frozen L3+L4 construction for G-v2."""
...
EXPERIMENTS = {
    "vggss_10k": {
        ...
        "default_experiment": "1.4G-v2-semantic_preserving_multigeom_vggss_10k",
        "eval_batch_size": 256,
        "workers": 16,
    ...
    "flickr_10k": {
        ...
        "default_experiment": "1.4G-v2-semantic_preserving_multigeom_flickr_10k_frame8_center5",
        "eval_batch_size": 32,
        "workers": 12,
