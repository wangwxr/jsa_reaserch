"""Experiment G-v2 training and gradient-diagnostic curves."""
...
def render_curves(
    ...
    axes[2, 0].plot(epochs, values("grad_norm_coarse"), label="coarse norm", color="#0072B2")
    axes[2, 0].plot(epochs, values("grad_norm_equiv"), label="equiv norm", color="#D55E00")
    axes[2, 0].plot(epochs, values("grad_norm_ratio"), label="equiv/coarse", color="#009E73")
    axes[2, 0].set_yscale("log")
    axes[2, 0].set_title("Gradient magnitude")
    axes[2, 0].legend()

    axes[2, 1].plot(epochs, values("grad_cosine"), label="gradient cosine", color="#CC79A7")
    axes[2, 1].plot(
        epochs,
        values("negative_grad_cosine_ratio"),
        label="negative-cosine ratio",
        color="#E69F00",
    )
