#!/usr/bin/env python3
"""Evaluate a 1.3G_14_14_L3 best checkpoint with the standard six JSA maps."""
...
def main() -> None:
    ...
    if checkpoint.get("architecture") != "1.3G_14_14_L3":
    ...
    print(f"Frozen 1.1.1_14_14_L3 teacher checkpoint: {base_checkpoint}", flush=True)
    ...
    result = {
        ...
        "map_definitions": {
            ...
            "IMG_QUERY": "frozen 1.1.1_14_14_L3 teacher Q4 -> K4, 7x7",
