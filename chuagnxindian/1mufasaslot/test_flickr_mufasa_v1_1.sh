...
echo "Architecture: mufasa_jsa_v1_1; spatial attention: l4_only; experiment: $experiment_name; checkpoint: $checkpoint; GPU: $gpu"

cd "$project_root"
"$python_bin" "$experiment_root/test_mufasa_v1_1.py" \
