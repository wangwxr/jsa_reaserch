"""Unchanged Experiment G data/config construction with the v2 model class."""
...
from model import VisualSemanticPreservingRefinement  # noqa: E402
...
EXPERIMENTS = {
    "vggss_10k": {
        ...
        "default_experiment": "1.3G-v2_vggss_10k",
        "original_g_experiment": "1.3G-multigeom_equivariant_l3_refine_vggss_10k_best",
        "eval_batch_size": 256,
        "workers": 16,
    ...
    "flickr_10k": {
        ...
        "default_experiment": "1.3G-v2_flickr_10k_frame8_center5",
        "original_g_experiment": "1.3G-multigeom_equivariant_l3_refine_flickr_10k_frame8_center5_best",
        "eval_batch_size": 32,
        "workers": 12,
    ...
    "vggss_144k": {
        ...
        "base_checkpoint": "vggss_best.pth",
        "default_experiment": "1.3G-v2_vggss_144k",
        "original_g_experiment": "1.3G-multigeom_equivariant_l3_refine_vggss_144k_best",
        "eval_batch_size": 256,
        "workers": 16,
    ...
    "flickr_144k": {
        ...
        "base_checkpoint": "flickr_best.pth",
        "default_experiment": "1.3G-v2_flickr_144k_frame8_center5",
        "original_g_experiment": "1.3G-multigeom_equivariant_l3_refine_flickr_144k_frame8_center5_best",
        "eval_batch_size": 32,
        "workers": 12,
...
def build_model(
...
) -> tuple[VisualSemanticPreservingRefinement, Path]:
    ...
    model = VisualSemanticPreservingRefinement(
...
def parameter_counts(model: VisualSemanticPreservingRefinement) -> dict[str, int]:
    ...
    return {
        ...
        "new_trainable_parameters_relative_to_G": trainable - 1_443_072,
    }
