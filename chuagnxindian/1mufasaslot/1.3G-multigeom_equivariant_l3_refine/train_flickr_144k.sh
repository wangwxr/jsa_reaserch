...
experiment_name=${2:-1.3G-multigeom_equivariant_l3_refine_flickr_144k_frame8_center5}
...
echo "Experiment G: Flickr-144k, GPU: $gpu, epochs: 50"
cd "$project_root"
"$python_bin" "$script_dir/train.py" \
    --experiment flickr_144k \
    --gpu "$gpu" \
    --epochs 50 \
