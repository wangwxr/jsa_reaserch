...
split=$1
gpu=${2:-0}
experiment_name=${3:-mufasa_jsa_v1_flickr_${split}}
...
echo "Architecture: mufasa_jsa_v1; experiment: $experiment_name; split: $split; GPU: $gpu"

cd "$project_root"
"$python_bin" "$experiment_root/train_mufasa.py" \
