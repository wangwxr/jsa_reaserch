...
log_file="$log_root/${experiment_name}_test_flickr_l4_only_${checkpoint_label}_${timestamp}.log"
exec > >(tee -a "$log_file") 2>&1
echo "Test log: $log_file"
echo "Architecture: mufasa_jsa_v1; eval: l4_only; experiment: $experiment_name; checkpoint: $checkpoint; GPU: $gpu"
