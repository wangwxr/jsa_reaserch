"""Formal Stage1 data/checkpoint construction for Experiment 2.4."""
...
EXPERIMENTS = {
    "vggss_144k": {
        ...
        "default_experiment": "2.4_object_aware_multigeom_spatial_specialization_vggss_144k",
        "original_g_experiment": "1.3G-multigeom_equivariant_l3_refine_vggss_144k",
        "eval_batch_size": 256,
        "workers": 16,
        "expected_aud": (0.4002, 0.4127),
        "original_g_aud": (0.4269, 0.4230),
    },
    "flickr_144k": {
        "dataset": "flickr",
        "base_experiment": "mufasa_ablation2_l3_l4_ablation_flickr_144k_frame8_center5",
        "base_checkpoint": "flickr_best.pth",
        "default_experiment": "2.4_object_aware_multigeom_spatial_specialization_flickr_144k_frame8_center5",
        "original_g_experiment": "1.3G-multigeom_equivariant_l3_refine_flickr_144k_frame8_center5",
        "eval_batch_size": 32,
        "workers": 12,
        "expected_aud": (0.8040, 0.6228),
        "original_g_aud": (0.8120, 0.6356),
    },
}
